...
/*   Updated: 2022/11/19 20:11:28 by amarini-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	find_type(std::string str)
{
	...
	if (str.size() == 1 && std::isdigit(str[0]) == 0)
		...
		|| ((((std::isdigit(str[0]) != 0 || str[0] == '.') && str.find_first_not_of("0123456789.f", 0) == std::string::npos)
		...
		|| ((((std::isdigit(str[0]) != 0 || str[0] == '.') && str.find_first_not_of("0123456789.", 0) == std::string::npos)
		|| (str[0] == '-' && str.find_first_not_of("0123456789.", 1) == std::string::npos))
		&& str.find_first_of(".", 0) == str.find_last_of(".", str.size() -1)
